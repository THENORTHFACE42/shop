...
| </span>		
 <span class="operate_nav">	 
<a href="index.cart" name="购物车" dd_name="购物车"><i class="icon_card"></i>购物车<b id="cart_items_count"></b></a> </span>
 </div>
...
<div class="header-wrap"><a href="index.do" class="logo" title="yershop商城系统"><img src="images/logo.png" alt=""></a>
...
<p><a class="btn_success" rel="nofollow" href="index.do">继续购物</a><a class="btn_success" rel="nofollow" href="userMain.do">查看订单</a></p></div>
